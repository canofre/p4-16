...
Alteracoes para implementacao com um header adicional. Testada somente no mininet.

   
1. Definir o header type e adicionar na struct header 
...
2. Atualiser o state parse_ipv4
...
3. Adcionnar o state ao final do parser
...
4. Substituir a logica do egress

      if ( meta.num_r > 0 ){ 
        // diffServ ja foi setado para 200 na primeira iteracao
        if ( hdr.ipv4.diffServ == 200 ){
...
5. Adicionar o header r no deparser
    ...
    packet.emit(hdr.r);
    ...
*/